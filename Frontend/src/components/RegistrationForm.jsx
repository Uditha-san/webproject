...
const RegistrationForm = ({ onClose, onSwitchToLogin }) => {
 ...
 const handleSubmit = async (e) => {
  ...
  try {
    ...
    // Optional: Save token or user data in context/localStorage
    login({
      id: data.user.id,
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      {/* Backdrop */}
      <div 
        className="absolute inset-0 bg-black bg-opacity-50 backdrop-blur-sm animate-backdropFadeIn"
        onClick={onClose}
      ></div>
      
      {/* Modal Content */}
      <div className="relative bg-white rounded-2xl shadow-2xl max-w-md w-full mx-4 max-h-[90vh] overflow-y-auto animate-modalSlideIn modal-content">
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        <form className="mt-8 space-y-6 animate-fadeInUp animation-delay-300" onSubmit={handleSubmit}>
          ...
          <div className="text-center animate-fadeInUp animation-delay-1300">
