    ...
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
      ...
      <div className='flex flex-col lg:flex-row mt-6 gap-6'>
        <div className='lg:w1/2 w-full'>
          <img src={mainImage} alt="Room img"
      ...
      <form className='flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0,15)] p-6 rounded-xl mx-auto
      mt-16 max-w-6xl'>
        ...
        <div className='flex flex-col'>
          <label htmlFor="checkOnDate" className='font-medium'>Check-Out</label>
          <input type="date" id='checkOnDate' placeholder='Check-Out' 
          className='w-full rounded border border-gray-300 px-3 py-2 mt-1.5
          outline-none ' required/>
      ...
      {/* hotel owner */}
      <div className='flex flex-col items-start gap-4 pt-4 mt-10 border-t border-gray-300'>
        <div className='flex gap-4'>
          <img src={room.hotel.owner.image} alt="host img"
        ...
        <button className='px-6 py-2.5 mt-4 rounded text-white bg-orange-500 hover:bg-orange-600
